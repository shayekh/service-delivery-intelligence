...
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>You've been invited to Service Delivery Intelligence</title>
</head>
<body style="margin:0;padding:0;background:#f1f5f9;font-family:Arial,sans-serif;color:#1e293b;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#f1f5f9;padding:32px 0;">
    <tr>
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
          ...
          <tr>
            <td style="background:#0f172a;padding:28px 36px;">
              ...
              <h1 style="margin:6px 0 0;font-size:20px;font-weight:700;color:#ffffff;line-height:1.3;">
                You've been invited to Service Delivery Intelligence
              </h1>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:32px 36px;">
              ...
              <p style="margin:0 0 24px;font-size:14px;line-height:1.6;color:#334155;">
                An account has been created for you as <strong>${role}</strong> in Service Delivery
                Intelligence. Set your password to get started.
              </p>
              <p style="margin:0 0 24px;text-align:center;">
                <a href="${actionLink}" style="display:inline-block;background:#2563eb;color:#ffffff;font-size:14px;font-weight:600;padding:10px 24px;border-radius:8px;text-decoration:none;">
                  Set your password
                </a>
              </p>
              <p style="margin:28px 0 0;font-size:14px;line-height:1.6;color:#334155;">
          ...
          <tr>
            <td style="background:#f8fafc;border-top:1px solid #e2e8f0;padding:16px 36px;text-align:center;">
              <p style="margin:0;font-size:11px;color:#94a3b8;">
                This invitation was generated by Service Delivery Intelligence
              </p>
            </td>
          </tr>
...
export async function sendInviteEmail({
  ...
  if (process.env.SEND_EMAIL !== "True") {
    console.log(`[email] SEND_EMAIL is not True — skipping invite email to: ${to}`);
    return;
  }
...
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>Reset your Service Delivery Intelligence password</title>
</head>
<body style="margin:0;padding:0;background:#f1f5f9;font-family:Arial,sans-serif;color:#1e293b;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#f1f5f9;padding:32px 0;">
    <tr>
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
          ...
          <tr>
            <td style="padding:32px 36px;">
              ...
              <p style="margin:0 0 24px;font-size:14px;line-height:1.6;color:#334155;">
                We received a request to reset your Service Delivery Intelligence password.
                Click below to choose a new one. If you didn't request this, you can safely
                ignore this email.
              </p>
              <p style="margin:0 0 24px;text-align:center;">
                <a href="${actionLink}" style="display:inline-block;background:#2563eb;color:#ffffff;font-size:14px;font-weight:600;padding:10px 24px;border-radius:8px;text-decoration:none;">
          ...
          <tr>
            <td style="background:#f8fafc;border-top:1px solid #e2e8f0;padding:16px 36px;text-align:center;">
              <p style="margin:0;font-size:11px;color:#94a3b8;">
                This password reset was requested from Service Delivery Intelligence
              </p>
            </td>
          </tr>
...
export async function sendPasswordResetEmail({
  ...
  if (process.env.SEND_EMAIL !== "True") {
    console.log(`[email] SEND_EMAIL is not True — skipping password reset email to: ${to}`);
    return;
  }
